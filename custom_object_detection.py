...
Original file is located at
    https://colab.research.google.com/drive/1vuFkvep6MeQNPK8ukCgqI8hxQupX57FG
"""
...
IMAGE_PATHS = '/content/training_demo/images/test/scene00291.png'
...
print(viz_utils.visualize_boxes_and_labels_on_image_array)
...
caegory_index = label_map_util.create_category_index_from_labelmap('/content/training_demo/annotations/label_map.pbtxt')

caegory_index

cap = cv2.VideoCapture('/content/training_demo/test.mp4')
